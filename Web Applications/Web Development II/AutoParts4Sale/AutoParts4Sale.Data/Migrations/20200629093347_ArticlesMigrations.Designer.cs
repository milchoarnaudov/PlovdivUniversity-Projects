...
namespace AutoParts4Sale.Data.Migrations
{
    ...
    [Migration("20200629093347_ArticlesMigrations")]
    partial class ArticlesMigrations
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AutoParts4Sale.Core.Article", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AutoParts4Sale.Core.CarModel", b =>
                {
                    b.HasOne("AutoParts4Sale.Core.CarMake", null)
                        .WithMany("CarModels")
                        .HasForeignKey("CarMakeId");
                });
